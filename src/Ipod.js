...
import sound from "./Firestone.mp3";
				...
				>
					<div style={styles.buttonContainer}>
						<div style={styles.menuButton}>
							<i onClick={this.changePageToHomeScreen} style={styles.image}>
								Menu
							</i>
						</div>
					</div>
...
const styles = {
	ipodContainer: {
		height: "33rem",
		width: "20rem",
		backgroundImage: "radial-gradient(rgb(218 218 218), rgb(164 169 172))",
		margin: "4rem auto",
		display: "flex",
		flexDirection: "row",
		flexWrap: "wrap",
	...
	wheel: {
		...
		height: "40%",
		margin: "1rem auto",
		backgroundColor: "rgb(213 216 220)",
		borderRadius: "50%",
		display: "flex",
		flexDirection: "row",
		flexWrap: "wrap",
